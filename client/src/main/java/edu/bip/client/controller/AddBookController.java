...
public class AddBookController  {
    ...
    private boolean isInputValid() {
        ...
        if (bookAuthor_box.getItems() == null || bookAuthor_box.getItems().size() == 0) errorMessage += "Не обнаружен автор книги!\n";
        if (bookPublisher_box.getItems() == null || bookPublisher_box.getItems().size() == 0) errorMessage += "Не обнаружено издание книги!\n";
